...
export const metadata: Metadata = createMetadata({
  title: 'Бренд одежды 13 (VN13) — каталог женской одежды | VN-13',
  description:
    'Каталог бренда одежды 13 (VN13): дизайнерская женская коллекция ограниченных серий, платья, жакеты, рубашки и брюки. Наличие и размеры — по запросу.',
  path: '/vn-13-brand',
...
const faq = [
  {
    question: 'Что означает бренд одежды 13 — VN13?',
    answer:
      'VN13 — это название проекта, а VN-13 — собственный бренд дизайнерской женской одежды внутри него. На странице собраны коллекция, категории, изображения моделей и информация о наличии.',
  },
  {
