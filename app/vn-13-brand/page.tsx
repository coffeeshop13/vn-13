...
export const metadata: Metadata = createMetadata({
  title: 'Бренд одежды 13 (VN13): каталог женской одежды | VN13',
  description:
    'Бренд одежды 13 — VN13: дизайнерская женская коллекция ограниченных серий, платья, жакеты, рубашки и брюки. Каталог, наличие и размеры — по запросу.',
  path: '/vn-13-brand',
