...
const galleryImages = brandGalleries[3]

export function MoyuruContent() {
  ...
  return (
    <main>
      ...
      <section className="relative w-full h-screen flex items-center justify-center overflow-hidden">
        <img src={galleryImages[0]?.src} alt="Moyuru Brand Cover - Japanese Avant-Garde Fashion" className="absolute inset-0 w-full h-full object-cover" />
