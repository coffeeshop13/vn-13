...
export const metadata: Metadata = {
  ...
  ...createMetadata({
    title: 'VN13 — бренд одежды, женская одежда и европейские дизайнерские марки',
    description:
      'VN13 — бренд одежды и премиальная женская одежда: лимитированные серии европейских дизайнеров, собственная коллекция VN-13 и работа с бутиками, шоурумами и клиентами.',
    path: '/',
