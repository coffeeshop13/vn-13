...
export const brandPortfolio: BrandPortfolioItem[] = [
  ...
  },
  {
    ...
    keywords: ['Moyuru', 'японская женская одежда', 'дизайнерская одежда', 'премиальная женская одежда'],
  ...
  },
  {
    ...
    keywords: ['Shoto', 'итальянская премиальная обувь', 'обувь для бутиков', 'лимитированные серии'],
  ...
  },
  {
    ...
    gallery: [
      ...
      { src: '/brands/post-and-co/dark-brown-double-belt.png', alt: 'Post & Co dark brown double leather belt' },
      { src: '/brands/post-and-co/black-gold-buckle-belt.png', alt: 'Post & Co black belt with gold buckle' },
      { src: '/brands/post-and-co/green-studded-sandals.png', alt: 'Post & Co green studded sandals' },
      { src: '/brands/post-and-co/brown-suede-loafer.png', alt: 'Post & Co brown suede loafer' },
    ],
  },
  {
    name: 'Aequamente',
  ...
  },
  {
    ...
    description:
      'SOH в портфеле VN13: корейская премиальная женская одежда, которая расширяет географию селекции и усиливает современное дизайнерское направление.',
    intro:
