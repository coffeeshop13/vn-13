...
export const brandPortfolio: BrandPortfolioItem[] = [
  ...
  },
  {
    ...
    description:
      'Aequamente в портфеле VN13: итальянская женская одежда с мягкой архитектурой и природной палитрой. Уточните коллекции, размеры и условия заказа.',
    intro:
  ...
  },
  {
    ...
    description:
      'Isabella Clementini в портфеле VN13: итальянская дизайнерская одежда, натуральные фактуры и вневременный гардероб для бутиков и клиентов.',
    intro:
