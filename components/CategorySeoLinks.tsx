      ...
      <div className="max-w-7xl mx-auto px-6 py-20 md:py-28">
        <div className="grid lg:grid-cols-[0.8fr_1.2fr] gap-12 lg:gap-20">
          <div>
            ...
            <h2 className="text-3xl md:text-4xl font-light mb-6 text-balance text-[#0f0f0f]">
          ...
          <nav aria-label="Категории дизайнерской одежды" className="grid sm:grid-cols-2 gap-px bg-[#e0ddd8] border border-[#e0ddd8]">
            {extendedSeoPages.map((page) => (
              <Link
                key={page.path}
                href={page.path}
                className="flex items-center justify-between gap-4 p-5 bg-[#fafaf8] transition-colors hover:bg-[#f3efe8]"
              >
