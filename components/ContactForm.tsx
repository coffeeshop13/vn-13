      ...
      <div className="max-w-7xl mx-auto px-6 py-12 md:py-16">
        <div className="max-w-3xl">
          ...
          <div className="mt-8 flex flex-col gap-3 sm:flex-row sm:flex-wrap">
            ...
            <a href="https://t.me/vn13agency" className="inline-flex min-h-[52px] items-center justify-center rounded-sm border border-[#8f867a] px-6 text-base font-medium text-white hover:bg-[#302d28]">
              Написать в Telegram
            </a>
