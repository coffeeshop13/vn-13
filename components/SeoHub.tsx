...
const links = [
  {
    ...
    text: 'Главный хаб по коллекциям, категориям, материалам и направлениям женской одежды VN-13.',
  },
  {
    href: '/vn-13-brand/',
  ...
  },
  {
    ...
    text: 'Сравнение французской, итальянской и азиатской женской одежды для подбора ассортимента.',
  },
  {
    href: '/japanese-style/',
    title: 'Японский стиль в одежде',
    text: 'Свободный крой, сложные силуэты и дизайнерские марки Японии в селекции VN13.',
  },
  {
  ...
  },
  {
    ...
    text: 'Почему лимитированные серии лучше работают в нишевой рознице и как VN13 подходит к ассортименту.',
  },
]
