...
const links = [
  ...
  },
  {
    ...
    text: 'Авторский визуальный язык, капсульная логика, посадка и материалы вне массового рынка.',
  },
  {
    href: '/premium-zhenskaya-odezhda',
    title: 'Премиальная женская одежда',
    text: 'Качественные ткани, ограниченные партии и спокойная эстетика собственного бренда VN-13.',
  },
  {
  ...
  },
  {
    ...
    text: 'Отдельная страница бренда женской одежды, эстетики, принципов и производственного подхода.',
  },
  {
    href: '/lookbook',
